...
namespace Ex2._4
{
    class Program
    {
         ...
         *   
         *   Define an override method for the ToString() method in order to represent your triangle as a string.
         *   Use your new ToString() method to write your triangle to the console.
         */
